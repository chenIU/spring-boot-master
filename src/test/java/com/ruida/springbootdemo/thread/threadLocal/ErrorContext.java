package com.ruida.springbootdemo.thread.threadLocal;

import java.util.ArrayList;
import java.util.List;

/**
 * @description: ThreadLocal可以理解为修饰变量使用的,被ThreadLocal修饰的变量是线程级别的,在多个函数之间都有效
 * @author: chenjy
 * @create: 2020-12-29 17:07
 */
public class ErrorContext {
    private List<String> messages = new ArrayList<>();

    private static final ThreadLocal<ErrorContext> threadLocal = new ThreadLocal<>();
    ...
    {
        ErrorContext context = threadLocal.get();
        if (context == null)
        {
